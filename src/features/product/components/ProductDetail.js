...
import { fetchProductByIdAsync,selectProductById, selectProductListFetchingStatus } from '../productSlice';
import {  addToCartAsync, selectAllCartItems } from '../../cart/cartSlice';
import { selectUserInfo } from '../../user/userSlice';
import { discountPrice } from '../../../app/constants';
import { useAlert } from "react-alert";
import ShimmerProductDetail from '../../shimmer/ShimmerProductDetail';
...
export default function ProductDetail() {
  ...
  if(status === 'idle'){
         ...
         <div className="pt-6">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p className="text-3xl tracking-tight text-gray-900 line-through font-light">${product.price}</p>
    ...
    return <ShimmerProductDetail></ShimmerProductDetail>
  }
