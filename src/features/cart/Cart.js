...
export default function Cart() {
  ...
  if(items.length>0){
    ...
    <div className=" text-base font-medium text-gray-900">
        <img src={emptyCart} alt="Empty Order" />
    </div>
    
    
    <div className="mt-6">
        <div className="flex items-center justify-center rounded-md bg-red-600 px-6 py-3 text-base font-medium text-white shadow-sm">
            Your cart is empty!!
        </div>
    </div>
