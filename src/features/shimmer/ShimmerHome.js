    ...
    return (
        <div className="bg-white">
          <div>
            ...
            {/* <MobileFilter  filters={filters}></MobileFilter> */}
          ...
          {products.map((product) => (
            ...
            <div className="h-[350.50px] group relative border-solid border-2 border-gray-200 p-2">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <div>
                <p className="text-sm block font-medium text-gray-900"></p>

                <p className="text-sm block font-medium line-through text-gray-400"></p>
                </div>
              </div>
