...
const ProductForm = () => {
  ...
  return (
    <form  noValidate onSubmit={handleSubmit((data)=>{
        ...
        delete product['image2']        //after making an array deleted the individual image variables
        ...
        if(id){    
            product.id = id                     // If id is present which means we are edting the product
            product.rating = selectedProduct.rating || 0;
            dispatch(updateProductAsync(product));                                      
        }
        else{                                   // Else we are creating an product
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 ">
                <select className='hide-scrollbar' {...register('brand',{
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 ">
                <select className='hide-scrollbar' {...register('category',{
